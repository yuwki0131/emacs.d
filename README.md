...
|移動|バッファ間|C-e C-c|shell|shell/repl/grepへ|
|移動|バッファ間|C-e C-v|move-to-scratch|shell/repl/grepへ|
|移動|バッファ間|C-e g|move-to-grep|shell/repl/grepへ|
|移動|バッファ間|C-e C-w|move-to-repl|shell/repl/grepへ|
